...
<body style="background: #d1d1d1;">
	...
	<div class="limiter" style="background: #d1d1d1;">
		...
		<button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" onclick="window.open('old_table_pdf.php');"><i class="fa fa-download fa-sm text-white-50"></i> Générer le rapport</button>
		...
		<div class="" style="background: #d1d1d1; width:1600px;">
			...
			<div class="" style="background: #d1d1d1;">
				<div align="center" class="container">
						<form  action="old_table.php" method="post" class="user-form">
							<?php
				...
				<div class="table100 ver1 m-b-110">
					<table data-vertable="ver1" style="width: 600px;">
						<thead>
							<tr class="row100 head">
								...
								$mois = ['JANVIER', 'FEVRIER', 'MARS', 'AVRIL', 'MAI', 'JUIN', 'JUILLET', 'AOUT', 'SEPTEMBRE', 'OCTOBRE', 'NOVEMBRE', 'DECEMBRE'];
								echo "  ".$mois[($_SESSION['month'])]." ".$_SESSION['year'];
								?></b></u></h5></th>
							</tr>
						</thead>
						...
						<tbody>
							...
							<tr class="row100">
								<td class="column100 column1" data-column="column1" style="width: 200px;"><b>TABLEAU ACTUEL:</b><button style="background: transparent; border: none"><a href="table.php"><i class="fa fa-table" style="font-size: 30px"></i></a></button></td>
				...
				<div class="table100 ver2">
					<table data-vertable="ver2 m-b-110" id="section_to_print">
						...
						<?php
							$t = new appartment();
							$disp = $t->old_table($_SESSION['month'], $_SESSION['year']);
