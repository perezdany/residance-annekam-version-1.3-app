                ...
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                      ...
                      $voir = (new reservation())->all_reserv($aujourd);
                      while($v = $voir->fetch())
                      {
                        ...
                        $new_format = date("d/m/Y", $timestampd);//changement du format
                          echo'<tr><td>'.$new_format.'   |   '.$v[2].'</td><td>'.$v[7].'</td><td>'.$v[13].' '.$v[4].' '.$v[5].'</td><td>'.number_format($v[8], 0, ',', ' ').'</td>';
                          if(intval($v[6] == 0))
                          ...
                          echo'
                            <td align="center">
                              ...
                              <div class="content" style="display:none;">
                                <form method="post" action="../Model/delete.php"><input type="text" value="'.$v[0].'" style="display: none;" name="id"><button class="btn btn-circle bg-gradient-danger" type="submit" name="delres"><font color="white"><i class="fa fa-trash"></i></font></button>
                                </form>
                                <button class="btn btn-circle bg-gradient-info">
                                      <a href="edit_reservation.php?id='.$v[0].'&amp;clt='.$v[12].'&amp;statut='.$v[6].'"><font color="white"><i class="fa fa-edit"></i></font>
                                      </a>
                                    </button>
