      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="month_recoveries_pdf.php"><button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Générer le rapport</button></a>
          </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                  ...
                  <tbody>
                    <?php
                      ...
                      $num_an = date('Y'); //l'an
                      $_SESSION['num_mois'] = intval($num_mois);
                      $_SESSION['num_an'] = intval($num_an);
                      $number = cal_days_in_month(CAL_GREGORIAN, ($_SESSION['num_mois']+1),$_SESSION['num_an']);
                      $_SESSION['number'] = $number;
                      $see = (new recovery())->months_recoveries($num_mois, $num_an);
                    ?>
                  </tbody>
                </table>
