      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Gestions des Lits</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive" id="section_to_print">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
	                <thead>
	                    <tr>
	                      <th>NUMERO DU LIT</th><th>NOMBRE DE PLACES</th><th><span>APPARTEMENT</span></th><th><span>ACTION</span></th>
	                    </tr>
	                </thead>
	                <tbody>
	                  <?php
	                  	//affichage des lits
	                  	$query = (new bed())->allbed();
                      while($see = $query->fetch())
                      {
                        echo'<tr><td>'.$see[0].'</td><td>'.$see[1].'</td><td>'.$see[2].'</td>
                        ...
                        <div class="content" style="display:none;">
                          <form method="post" action="../phps/delete.php"><input type="text" value="'.$see[0].'" style="display: none;" name="id"><button class="btn btn-circle bg-gradient-danger" type="submit" name="delbed"><font color="white"><i class="fa fa-trash"></i></font></button>
                          </form>
                          <button class="btn btn-circle bg-gradient-info" type="" name=""><a href="bed.php?id='.$see[0].'&amp;p='.$see[1].'"><font color="white"><i class="fa fa-edit"></i></font></a></button>
                        </div>
                        </td>
                        </tr>';
                      }
		...
		<div class="container">
           ...
           <?php
              ...
              {
                $query = $bdd->query("SELECT SQL_NO_CACHE l.id_lit, l.nb_place, a.lib_appart, a.id_appart FROM lit l, appartement a WHERE a.id_appart=l.id_appart AND l.id_lit='".$_GET['id']."'");
                $voir =$query->fetch();
                echo' <div class="row">
                          ...
                          <div class="col-lg-6">
                              <div class="p-5">
                                ...
                                <div class="text-center">
                                  <h1 class="h4 text-gray-900 mb-4">Modification de Lits</h1>
                                </div>
                                <form class="user" method="post">
                                      <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id=""  name="nb" required value="'.$_GET['p'].'">
                                      </div>
                                      <div class="form-group">
                                        Appartement:
                                        <select type="password" class="form-control" id="" name="bat" required>';
                                          echo'<option value="'.$voir[3].'">'.$voir[2].'</option>';
                                            $liste =  $bdd->query("SELECT * FROM appartement ");
                                            while($see = $liste->fetch())
                                            {
                                              echo'<option value="'.$see[0].'">'.$see[1].'</option>';
                                            }
                                      ...
                                      if (isset($_POST['go']))//si on on a cliqué sur le boutton
                                      {
                                        ...
                                        if(isset($_POST['nb']) AND isset($_POST['bat']))
                                        {
                                     
                                          $nb = intval($_POST['nb']);
                                            $bat = htmlspecialchars($_POST['bat']);
                                            $addbed = (new bed())->edit_bed($nb, $bat, $_GET['id']);
                                            echo'<font color="green">Lit modifié avec succès!</font>';
                                        }                  
                                      }
                 ...
                 echo' <div class="row">
                          ...
                          <div class="col-lg-6">
                              <div class="p-5">
                                <hr/>
                                <div class="text-center">
                                  <h1 class="h4 text-gray-900 mb-4">Ajout de Lits</h1>
                                </div>
                                <form class="user" method="post">
                                      <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="" placeholder="Nombre de places"  name="nb" required>
                                      </div>
                                      <div class="form-group">
                                        Appartement:
                                        <select type="password" class="form-control" id="" name="bat" required>';
                                      ...
                                      if (isset($_POST['go']))//si on on a cliqué sur le boutton
                                      {
                                        ...
                                        if(isset($_POST['nb']) AND isset($_POST['bat']))
                                        {
                                          ...
                                          $nb = intval($_POST['nb']);
                                            $bat = htmlspecialchars($_POST['bat']);
                                            $addbed = (new bed())->addbed($nb, $bat);
                                            echo'<font color="green">Lit ajouté avec succès!</font>';
                                        }                  
                                      }
