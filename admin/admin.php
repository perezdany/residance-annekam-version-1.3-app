<?php
  session_start();
  //securité en cas de session fermée
  ...
  //iimporter le fichier de configuration de connexion de la base de données
  include("../Model/confige.php");
  //charger le fichier(module) de la classe Admin
                      ...
                      while($aff = $see->fetch())
                      {
                        ...
                        <td><button type="button" class="collapsible btn btn-circle bg-gradient-success"><font color="white"><i class="fa fa-angle-down"></i></font></button>
                          <div class="content" style="display:none;"> 
                            <form method="post" action="../phps/delete.php"><input type="text" value="'.$aff[0].'" style="display: none;" name="id"><button class="btn btn-circle bg-gradient-danger" type="submit" name="dela"><font color="white"><i class="fa fa-trash"></i></font></button></form>
                            <button class="btn btn-circle bg-gradient-info"><a href="edit_admin.php?ps='.$aff[1].'&amp;id='.$aff[0].'"><font color="white"><i class="fa fa-edit"></i></font></a></button>
                          </div>
                        </td>
                        </tr>';
                      }
							    ...
							    <div class="col-lg-12">
							        <div class="p-5">
							          ...
							          <div class="text-center">
							            <h1 class="h4 text-gray-900 mb-4">Ajout d'Administrateur</h1>
							          </div>
							          <form class="user" method="post" action="add_admin.php">
							            <div class="form-group row">
  										   	  <div class="col-sm-6 mb-3 mb-sm-0">Pseudo:</div>
  							            <div class="col-sm-6">
  							             <input type="text" name="ps" class="form-control form-control-user">
  							            </div>
										      </div>
                          <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">Mot de Passe:</div>
                            <div class="col-sm-6">
                             <input type="" name="mdp" class="form-control form-control-user" required>
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">Type:</div>
                            <div class="col-sm-6" >
