		        	...
		        	<div class="card o-hidden border-0 shadow-lg my-5">
		        		<div class="card-body p-0">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                             <input type="password" name="mdp" class="form-control form-control-user" required>
                            </div>
                          </div>
                           <div class="form-group row">
											      ...
											      if(isset($_POST['ok']))
                            {
                              if(isset($_POST['ps']) AND isset($_POST['mdp']))
                              {
                                ...
                                $add_admin = (new admin())->add_admin($pseudo, $mdp, $type);
                                echo'<font color="green">Administrateur ajouté avec succès!! Cliquez <a href="../index.php"><font color="blue">ici</font></a> pour vous connecter</font>';
                              }
                            }
										      ?>
							          </form><br>
